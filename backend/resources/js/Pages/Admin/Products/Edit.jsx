...
import { Package, ArrowLeft, Save, DollarSign, Eye, Tag, FileText } from 'lucide-react';
            ...
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-obsidian-500 mt-0.5">Update product details</p>
                    </div>
                </div>
            }
        >
                                ...
                                <form onSubmit={submit} className="space-y-5 sm:space-y-6">
                                    <div>
                                        <label className="label-premium flex items-center gap-2">
                                            <Tag className="h-3.5 w-3.5 text-electric-400" />
                                            Product Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="label-premium flex items-center gap-2">
                                            <FileText className="h-3.5 w-3.5 text-electric-400" />
                                            Description
                                        </label>
                                        <textarea
                                            name="description"
                                    ...
                                    <div>
                                        <label className="label-premium flex items-center gap-2">
                                            <DollarSign className="h-3.5 w-3.5 text-electric-400" />
                                            Price
                                        </label>
                        ...
                        <div className="opacity-0 animate-reveal" style={{ animationDelay: '0.15s' }}>
                            <div className="lg:sticky lg:top-24">
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="p-1.5 rounded-lg bg-gradient-to-br from-electric-500/15 to-electric-600/10 border border-electric-500/15">
                                        <Eye className="h-3.5 w-3.5 text-electric-400" />
                                    </div>
                                ...
                                <div className="bg-gradient-to-br from-obsidian-800/80 to-obsidian-900/60 backdrop-blur-xl rounded-2xl border border-obsidian-600/15 shadow-card p-5 sm:p-6 overflow-hidden group hover:border-electric-500/25 transition-all duration-300">
                                    <div className="absolute -top-12 -right-12 w-24 h-24 bg-gradient-to-br from-electric-500/10 to-transparent rounded-full blur-2xl pointer-events-none group-hover:opacity-80 transition-opacity" />
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="p-2.5 rounded-xl bg-obsidian-800/60 border border-obsidian-600/20 group-hover:border-electric-500/25 transition-colors">
                                                <Package className="h-5 w-5 text-electric-400" />
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm font-bold text-white truncate">{data.name || 'Product Name'}</p>
                                                <p className="text-[11px] text-obsidian-500">Product</p>
                                            </div>
                                        </div>
                                        ...
                                        <p className="text-xs text-obsidian-400 leading-relaxed min-h-[3rem]">
                                            {data.description || <span className="text-obsidian-600 italic">No description provided</span>}
                                        </p>
                                        <div className="mt-4 pt-4 border-t border-obsidian-600/20">
                                            ...
                                            <p className="text-2xl font-bold font-mono text-transparent bg-clip-text bg-gradient-to-r from-electric-400 to-emerald-400 mt-1">
